...
<div style="width:100%;text-align:center;"><img title="To Top" class="toTopArrow" src="img/arrows/arrowToTop.png" onClick="javascript:$('html,body').animate({scrollTop:0},300);" /></div>